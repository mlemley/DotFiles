...
hi Visual	term=bold cterm=bold,underline ctermbg=black gui=bold guifg=bold guibg=black
...
hi WarningMsg	term=standout ctermfg=red gui=bold guifg=red
...
hi CursorLine term=none cterm=none ctermbg=black guibg=darkgray
hi PMenu term=standout ctermfg=gray ctermbg=darkgray guifg=black guibg=darkgray
hi PMenuSel term=standout ctermfg=white ctermbg=blue guifg=white guibg=darkblue

" syntax hi colors
hi Comment	term=bold ctermfg=darkgray guifg=ivory4
...
hi Error	term=reverse ctermfg=gray ctermbg=red guifg=gray guibg=red2
